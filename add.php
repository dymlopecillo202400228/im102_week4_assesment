     ...
     $sql = "INSERT INTO students (name, course, year, email, phone, address) VALUES ('$name',
        ...
        Redirecting...</p>';
          header('Refresh: 2; URL=index.php');
            ...
            Dela Cruz">
            <label>Email</label>
            <input type="email" name="email" required placeholder="e.g.
            juan.delacruz@example.com">
            <label>Phone</label>
            <input type="tel" name="phone" required placeholder="e.g.
            09123456789">
            <label>Address</label>
            <input type="text" name="address" required placeholder="e.g.
